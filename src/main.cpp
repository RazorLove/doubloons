...
uint256 hashGenesisBlock("0xbbd01e417e370842498a91038fd40da95f4a6166a231a3bed3c4671207bd8296");
...
const string strMessageMagic = "Doubloons Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal doubloons miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Doubloons", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa97b153a38b9d7879a75bd9cdf2bff1f4fc3cb156eaea52528b32927d9436836");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1368588225;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 489173;

        if (fTestNet)
        {
            block.nTime    = 1368588210;
            block.nNonce   = 1147749;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x544583aec6ed7f7f045be86c3de9bd9043aca5968e30c82a276e76154cf34ef9"));
